...
with open('SetRelayOutputState.xml', 'r') as myfile:
    data = myfile.read()
username = "service"
password = "iPilot!19"
...
text_file.close()
os.system("curl --silent -X POST --header 'Content-Type: text/xml; charset=utf-8;; action=\"http: // www.onvif.org/ver20/ptz/wsdl/Stop\"' --header 'SOAPAction: \"http: // www.onvif.org/ver20/ptz/wsdl/Stop\"' -d @test.xml 'http://192.168.99.241/onvif/device_service' | xmllint --format -")
